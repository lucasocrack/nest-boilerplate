...
export class AuthController {
  ...
  @ApiResponse({ status: 429, description: 'Muitas tentativas de login - rate limit atingido' })
  ...
  @ApiResponse({ status: 201, description: 'Usuário registrado com sucesso - email de ativação enviado' })
  @ApiResponse({ status: 400, description: 'Dados inválidos fornecidos' })
  @ApiResponse({ status: 409, description: 'Usuário já existe (email, username ou CPF duplicado)' })
  @ApiResponse({ status: 429, description: 'Muitas tentativas de registro - rate limit atingido' })
  ...
  @ApiResponse({ status: 200, description: 'Token de redefinição gerado e enviado por email' })
  @ApiResponse({ status: 400, description: 'Email inválido' })
  @ApiResponse({ status: 404, description: 'Usuário não encontrado' })
  @ApiResponse({ status: 429, description: 'Muitas tentativas - rate limit atingido' })
  ...
  @ApiResponse({ status: 400, description: 'Dados inválidos ou senhas não conferem' })
  ...
  @ApiResponse({ status: 400, description: 'Token de ativação inválido ou expirado' })
  ...
  @ApiResponse({ status: 200, description: 'Email de ativação reenviado com sucesso' })
